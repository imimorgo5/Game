...
{
    public class PauseStateView : StateView
    {
        ...
        public PauseStateView(Vector2 visualShift) : base(visualShift) { }
        ...
        {
            spriteBatch.Draw(backgrounds[(byte)ViewType.PauseStateView], new Vector2(0, 0), Color.White);
