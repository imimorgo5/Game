...
namespace RoadRacesMVP
{
    public static class Factory
    {
        ...
        private static Car CreateClassicCar(float x, float y, Vector2 speed, Vector2 maxSpeed)
        {
        ...
        public static IObject GenerateObject(char sign, float xTile, float yTile)
        {
            ...
            {
                case 'C':
                    generatedObject = CreateClassicCar(x, y, new(0, 0), new(0, new Random().Next(-35, -25)));
                    break;
                case 'P':
