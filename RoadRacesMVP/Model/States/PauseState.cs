...
namespace RoadRacesMVP
{
    public class PauseState : IState
    {
        ...
        public PauseState(PauseArgs pauseArgs)
        {
            PauseArgs = pauseArgs;
        }
        ...
        public void Initialize()
        {
            ...
            var quitToMenuButton = new Button(new(735, 695), 450, 125, (byte)ObjectTypes.bigButton, ActionType.quitToMenu, "Выйти в меню");
